...
from src.caption.internvl.InternVL.internvl_chat.internvl.conversation import conv_templates, SeparatorStyle
from src.caption.internvl.InternVL.internvl_chat.internvl.model.builder import load_pretrained_model
